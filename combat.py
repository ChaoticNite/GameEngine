...
class Combat(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.attkBttn.grid(row = 0, column = 1, sticky = (tk.E + tk.W), padx = 0, pady = 0)
        self.heroLbl.grid(row = 0, sticky = tk.W, rowspan = 3)
        self.enemyLbl.grid(row = 0, sticky = tk.E, rowspan = 3)
