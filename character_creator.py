...
class Help(tk.Frame):
    ...
    def create_widgets(self):     
        ...
        simpleTxt = tk.Text(self, width = 70, height = 12, wrap = 'word')
        ...
        hardcoreTxt = tk.Text(self, width = 70, height = 12, wrap = 'word')
        ...
        fourDTxt = tk.Text(self, width = 70, height = 12, wrap = 'word')
